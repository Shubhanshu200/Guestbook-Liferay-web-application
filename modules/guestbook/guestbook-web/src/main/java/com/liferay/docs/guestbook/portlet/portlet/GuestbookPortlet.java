...
import com.liferay.excel.ExportRequestExcel;
 ...
 * @author me
 */
//component class metadata properties configurationSSSS
@Component(
	immediate = true,
	property = {
...
public class GuestbookPortlet extends MVCPortlet {
	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)throws IOException, PortletException {
		...
		try {
			...
			if("exportExcel".equalsIgnoreCase(resourceId)) {
				
				String fileName="GuestBookEntry"+ new SimpleDateFormat("dd-mm-yyyy").format(new Date())+ ".xlsx";
				
				ExportRequestExcel.exportExcel(resourceRequest, resourceResponse, GuestbookEntryLocalServiceUtil.getGuestbookEntries(-1, -1), fileName);
			}	
